...
class AccelerationFuzzy():
    ...
    def conclude(self,L,D,LK,DK,V,S,printRuleIndex=None,printUnion=False):
        ...
        if printRuleIndex!=None:
            print('Pravilo:')
            print(r[printRuleIndex])
            print('Dekodirana vrijednost pravila:')
            print(self.defuzzyfier(r[printRuleIndex]))
        ...
        if printUnion:
            print('Unija:')
            print(union)
            print('Dekodirana vrijednost unije:')
            print(self.defuzzyfier(union))
